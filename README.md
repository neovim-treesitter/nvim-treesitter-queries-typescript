# nvim-treesitter-queries-typescript

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-typescript/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-typescript/actions/workflows/validate.yml)

Neovim tree-sitter queries for **typescript**, part of the
...
- [ ] Changes are scoped to `typescript` — do not include files for other languages
